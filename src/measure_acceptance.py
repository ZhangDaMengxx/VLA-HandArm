...
用法:
    python3 src/measure_acceptance.py --robot nero_inspire_rgbd --json src/out/metrics_nero_inspire_rgbd.json
    python3 src/measure_acceptance.py --robot nero_gripper_rgbd          # 仅打印
"""
import argparse
import json
import sys
...
def measure_sync(df, robot):
    ...
    info_p = REPO / f"src/out/lerobot_ds_{robot}/meta/info.json"
...
if __name__ == "__main__":
    ...
    ap.add_argument("--canonical", default=str(REPO / "src/out/canonical_ds"))
