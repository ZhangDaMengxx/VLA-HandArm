...
用法:
  python3 src/verify_force_limits.py                    # 只读当前值,不写
  python3 src/verify_force_limits.py --write             # 写 1500 再读回对照
  python3 src/verify_force_limits.py --write --port /dev/ttyUSB0
"""
