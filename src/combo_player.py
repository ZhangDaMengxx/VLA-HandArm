#!/usr/bin/env python3
"""src/combo_player.py — 臂 + 手的**联合回放器**:一条时间轴,两个设备。
...
## 用法
    ...
    python3 src/combo_player.py out/arm_pack_robot_traj_nero_inspire_rgbd.json
    python3 src/combo_player.py <臂包> --hand <手包相对路径> --dry-run
    python3 src/combo_player.py <臂包> --no-mock-arm --yes     # 真臂!
"""
