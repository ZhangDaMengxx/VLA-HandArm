...
switching videos:
  python src/build_canonical.py --video data/hand3.mp4

Examples:
  python src/analyze_wrist_segments.py
  python src/analyze_wrist_segments.py --segment flip=410:425 --segment swing=180:190
  python src/analyze_wrist_segments.py --basis 3.14159265359 0 0
  python src/analyze_wrist_segments.py --flip-target +Z --swing-target +X
"""
