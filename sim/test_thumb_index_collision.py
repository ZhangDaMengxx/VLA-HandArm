...
用法:
  python3 sim/test_thumb_index_collision.py                 # t1-t4
  python3 sim/test_thumb_index_collision.py --only t5       # 先验方法(~5min)
  python3 sim/test_thumb_index_collision.py --only t6       # 再扫二维(~20min)
"""
