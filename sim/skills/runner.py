#!/usr/bin/env python3
"""sim/skills/runner.py — 技能执行器(跑在 ROS2 system python3)。
...
两种用法:
  单发:python3 sim/skills/runner.py --once '{"skill_id":"go_home","confirmed":true}'
  流式:python3 sim/skills/runner.py      # 逐行读 stdin 信封
