...
用法:
  python3 sim/skills/gen_phrasings.py                    # 只看统计和体检
  python3 sim/skills/gen_phrasings.py --out out/phrasings.yaml
  python3 sim/skills/gen_phrasings.py --check            # 体检不过就退出码 1
"""
...
# 只放 skills/ —— sim/schema.py 与 skills/schema.py 撞名,放了 sim/ 会 import 到错的。
